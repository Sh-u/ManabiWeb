...
exports.Migration20220701205304 = void 0;
const migrations_1 = require("@mikro-orm/migrations");
class Migration20220701205304 extends migrations_1.Migration {
    async up() {
        ...
        this.addSql('create table "card" ("_id" serial primary key, "sentence" text not null, "word" text not null, "furigana" text null, "image" text null, "dictionary_meaning" text null, "dictionary_audio" text null, "pitch_accent__id" int null, "user_audio" text null, "deck__id" int not null, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null);');
        this.addSql('alter table "card" add constraint "card_pitch_accent__id_unique" unique ("pitch_accent__id");');
        ...
        this.addSql('alter table "pitch_accent" add constraint "pitch_accent_card__id_unique" unique ("card__id");');
        ...
        this.addSql('alter table "card" add constraint "card_pitch_accent__id_foreign" foreign key ("pitch_accent__id") references "pitch_accent" ("_id") on update cascade on delete set null;');
    ...
    async down() {
        ...
        this.addSql('alter table "card" drop constraint "card_pitch_accent__id_foreign";');
...
exports.Migration20220701205304 = Migration20220701205304;
//# sourceMappingURL=Migration20220701205304.js.map